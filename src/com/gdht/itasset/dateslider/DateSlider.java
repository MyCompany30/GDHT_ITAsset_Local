...
import com.gdht.itasset.dateslider.SliderContainer.OnTimeChangeListener;
...
//	private static String TAG = "DATESLIDER";
    ...
    public DateSlider(Context context, int layoutID, OnDateSetListener l, Calendar initialTime, String titleStr) {
    	this(context,layoutID,l,initialTime, null, null, 1, titleStr);
    }
    
    public DateSlider(Context context, int layoutID, OnDateSetListener l, Calendar initialTime, int minInterval, String titleStr) {
    	this(context,layoutID,l,initialTime, null, null, minInterval, titleStr);
    }
    
    public DateSlider(Context context, int layoutID, OnDateSetListener l,
            Calendar initialTime, Calendar minTime, Calendar maxTime, String titleStr) {
    	this(context,layoutID,l,initialTime, minTime, maxTime, 1, titleStr);
    }
    
    public DateSlider(Context context, int layoutID, OnDateSetListener l,
            Calendar initialTime, Calendar minTime, Calendar maxTime, int minInterval, String titleStr) {
        super(context);
